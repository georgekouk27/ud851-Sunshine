...
public class MainActivity extends AppCompatActivity {
    ...
    private TextView tvWeatherShow;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvWeatherShow = (TextView) findViewById(R.id.tv_weather_data);

        // COMPLETED (3) Create an array of Strings that contain fake weather data
        String[] weatherData = {
                "Today, Nov 05 - Clear - 17°C / 15°C",
                ...
                "Fri, May 27 - Stormy - 21°C / 9°C",
                "Sat, May 28 - Stormy - 16°C / 7°C",
                "Sun, May 29 - Cloudy - 16°C / 8°C",
                "Mon, May 30 - Cloudy - 15°C / 10°C",
        };

        // COMPLETED (4) Append each String from the fake weather data array to the TextView
        for (String aWeatherData : weatherData) {
            tvWeatherShow.append(aWeatherData + "\n\n\n");
        }
    }
}